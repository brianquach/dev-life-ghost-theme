...
(function ($, undefined) {
    ...
    $.fn.arctic_scroll = function (options) {
        ...
        allOptions.elem.click(function (event) {
            var el = defaults.elem;
            var $this = defaults.$elem;
            ...
            if (offset) {
                ...
                $htmlBody.stop(true, false).animate({ scrollTop: $(el.hash).offset().top + toMove }, allOptions.speed);
            } else if (position) {
                toMove = parseInt(position);
                $htmlBody.stop(true, false).animate({ scrollTop: toMove }, allOptions.speed);
            } else {
                $htmlBody.stop(true, false).animate({ scrollTop: $(el.hash).offset().top }, allOptions.speed);
            }
        });
    };
})(jQuery);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--2-1!../../../node_modules/postcss-loader/lib/index.js??ref--2-2!./screen.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js??ref--2-1!../../../node_modules/postcss-loader/lib/index.js??ref--2-2!./screen.css");
